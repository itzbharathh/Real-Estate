...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "1747a6d9-69c3-4624-86ec-652a4da8f9f2");
  ...
  return (
      ...
      viewport={{ opacity: 1, y: 0 }}
          ...
          <p className=' text-gray-500 mb-12 max-w-80 text-center'>Ready
          ...
          <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
              <div className='flex flex-wrap'>
                  <div className='w-full md:w-1/2 text-left'>
                      Your Name
                      <input type="text" placeholder='Enter Your Name' name='Name' className='w-full border border-gray-300 rounded
                      py-3 px-4 mt-2' required />
                  </div>
                  <div className='w-full md:w-1/2 text-left md:pl-4'>
                      Your Email
                      <input type="email" placeholder='Enter Your Email' name='Email' className='w-full border border-gray-300 rounded
                      py-3 px-4 mt-2' required />
                  </div>
              </div>
